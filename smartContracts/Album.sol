...
contract NFT is ERC721URIStorage {
    ...
    constructor() ERC721("NonFungiMusic", "NFM") {
        owner = msg.sender;
        createToken("ipfs/QmfAwYLS41U3PTzu1igUXqLdCMnurJumysGjDLdqs41hTq/metadata/0.json");
        createToken("ipfs/QmfAwYLS41U3PTzu1igUXqLdCMnurJumysGjDLdqs41hTq/metadata/1.json");
    }
